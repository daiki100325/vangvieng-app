<template>
    <footer v-if="(appMode !== null && currentStep > 0) || (appMode === 'transfer' && transferStep !== 0) || appMode === 'stock'" class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-slate-200 p-4 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] z-20 pb-safe-area">
