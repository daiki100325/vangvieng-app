...
export default {
    ...
    props: {
        ...
        theme: {
            type: String,
            default: 'inventory', // 'inventory', 'request', 'transfer', 'stock'
            validator: (value) => ['inventory', 'request', 'transfer', 'stock'].includes(value)
        }
    },
    ...
    computed: {
        themeColorClass() {
            return {
                ...
                stock: 'bg-red-600 shadow-red-500/40'
            }[this.theme]
        },
        themeTextColorClass() {
             return {
        ...
        themeActiveButtonClass() {
            return {
                ...
                stock: 'bg-red-600 text-white shadow-md shadow-red-500/30'
            }[this.theme]
        },
        themeInactiveButtonClass() {
            return {
                ...
                stock: 'bg-slate-100 text-slate-600 hover:bg-red-50 hover:text-red-600'
            }[this.theme]
        }
    },
    methods: {
