...
const transferAppPath = path.join(__dirname, 'components/apps/TransferApp.vue');

let appVueContent = fs.readFileSync(appVuePath, 'utf8');

// --- 1. Create TransferApp.vue ---

const transferAppVueContent = `<template>
...
fs.writeFileSync(transferAppPath, transferAppVueContent, 'utf8');
console.log('Created TransferApp.vue');
